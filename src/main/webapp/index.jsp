...
<head>
  ...
  <title>LUMINA · Modern Lifestyle Store</title>
  ...
  <style>
    ...
    *::after {
    ...
    :root {
      ...
      --primary-glow: rgba(59, 91, 219, 0.3);
      --accent: #f59f00;
      --bg: #f8f9fc;
      --bg-card: #ffffff;
      --text: #0b1b33;
      --text-secondary: #3e4b61;
      --text-muted: #7f8b9d;
      --border: #e2e7f0;
    ...
    /* ============================================================
       HERO — fresh gradient & glassmorphism
       ============================================================ */
    .hero {
      position: relative;
      background: linear-gradient(145deg, #eef2ff 0%, #ffffff 50%, #f1f5ff 100%);
      padding: 80px 0 70px;
      overflow: hidden;
      isolation: isolate;
    ...
    .hero::before {
      ...
      position: absolute;
      inset: 0;
      background: radial-gradient(ellipse at 80% 30%, rgba(59, 91, 219, 0.08) 0%, transparent 55%),
        radial-gradient(ellipse at 10% 70%, rgba(245, 159, 0, 0.06) 0%, transparent 50%);
      z-index: 0;
    }
    .hero .container {
      position: relative;
    ...
    .hero-content h1 .highlight {
      background: linear-gradient(135deg, var(--primary), #8ba3ff);
    ...
    .hero-visual .hero-grid img:hover {
      ...
      box-shadow: 0 20px 48px rgba(59, 91, 219, 0.15);
    }
    ...
    .category-card::before {
      ...
      position: absolute;
      inset: 0;
      background: linear-gradient(145deg, var(--primary), #6b8aff);
      opacity: 0;
      transition: var(--transition);
      border-radius: var(--radius);
    }
    ...
    /* ============================================================
       PRODUCTS — clean cards with soft shadows
       ============================================================ */
    .products-grid {
      display: grid;
    ...
    .newsletter-section {
      ...
      box-shadow: 0 8px 32px rgba(59, 91, 219, 0.06);
    }
    .newsletter-section::before {
      content: '';
      position: absolute;
      inset: 0;
      background: radial-gradient(ellipse at 30% 50%, rgba(59, 91, 219, 0.06), transparent 60%);
      z-index: 0;
    }
...
<body>
  ...
  <section class="hero">
    <div class="container">
      <div class="hero-content">
        <div class="tag" style="display:inline-block;background:rgba(59,91,219,0.08);color:var(--primary);font-weight:600;font-size:0.75rem;text-transform:uppercase;letter-spacing:1.5px;padding:4px 16px;border-radius:9999px;margin-bottom:16px;">
          <i class="fas fa-sparkles" style="margin-right:6px;"></i> New Season 2026
        </div>
        <h1>
          Elevate Your<br />
    ...
    <div class="container">
      <div class="newsletter-section">
        <div class="container">
          ...
          <p style="margin-top:16px;font-size:0.8rem;color:var(--text-muted);">No spam, unsubscribe anytime.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="footer-grid">
        <div class="footer-about">
          <div class="brand-footer">
            <i class="fas fa-store"></i> LUMINA<span>SHOP</span>
          </div>
  ...
  <script>
    (function() {
      ...
      console.log('LUMINA · Modern Lifestyle Store loaded ✨');
