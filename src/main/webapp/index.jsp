...
<head>
  ...
  <title>E-COM_Shopping · Modern Lifestyle Store</title>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">

  <style>
    body { font-family:'Inter', sans-serif; margin:0; background:#f4f5f7; color:#222; }
    header { background:#fff; border-bottom:1px solid #ddd; position:sticky; top:0; z-index:100; }
    .header-inner { max-width:1200px; margin:auto; display:flex; justify-content:space-between; align-items:center; padding:12px 20px; }
    ...
    .card { background:#fff; border-radius:12px; padding:20px; text-align:center; box-shadow:0 4px 12px rgba(0,0,0,.05); transition:.3s; }
    ...
    footer { background:#fff; border-top:1px solid #ddd; padding:40px 20px; text-align:center; color:#666; }
...
<body>
  ...
  <header>
    <div class="header-inner">
      <a href="#" class="brand"><i class="fas fa-store"></i> E-COM_Shopping</a>
      <nav>
        <ul>
          <li><a href="#">Home</a></li>
  ...
  <!-- HERO -->
  <section class="hero">
    <h1>Welcome to E-COM_Shopping</h1>
  ...
  <!-- FOOTER -->
  <footer>
    <p>&copy; 2026 E-COM_Shopping · All Rights Reserved</p>
    <div class="social">
